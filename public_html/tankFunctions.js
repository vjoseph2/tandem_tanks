...
function Bullet(owner) {
    ...
    tBullet = new Sprite(game, "bullet.png", 20, 20);
...
function UserTank() {
    ...
    tTank = new Sprite(game, "playertank2.png", 50, 25);
    tTank.setSpeed(0);
    tTank.setPosition(100, 473);

    tTank.turret = new Sprite(game, "turretplayer.png", 25, 12.5);
...
function DroneTank() {
    //creates AI tank
    eTank = new Sprite(game, "enemyplayertank.png", 50, 25);
    eTank.setSpeed(0);
    eTank.setPosition(450, 473);
    eTank.turret = new Sprite(game, "turretplayer2.png", 25, 12.5);
    ...
    eTank.enemyHit = function () {
        ...
        if (noDamage - bTimer.getElapsedTime() >= 1.4) {
            eTank.changeImage("cexplosion1.png");
            eTank.width = 100;
            eTank.height = 65;
        } else if (noDamage - bTimer.getElapsedTime() >= 0.7) {
            eTank.changeImage("cexplosion2.png");
        } else if (noDamage - bTimer.getElapsedTime() >= 0.1) {
            eTank.changeImage("cexplosion3.png");
        } else if (noDamage - bTimer.getElapsedTime() >= 0) {
            eTank.width = 50;
            eTank.height = 25;
            eTank.changeImage("enemyplayertank.png");
        }
    }//end enemyhit
...
function decr() {
    ...
    if (health < 30) {
        tankRed.changeImage("playertank3inj3.png");
    }
        ...
        tankRed.changeImage("enemywithoutturret.png");
...
function init() {
    ...
    background = new Sprite(game, "tankeveningbackgroundgrass.png", 800, 600);
